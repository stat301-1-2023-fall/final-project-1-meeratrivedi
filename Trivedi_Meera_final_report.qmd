...
Next I decided to explore each measure of popularity separately. @fig-density1 shows the frequency of IMDB ratings for all 10 seasons. I wanted to get a sense of how much people like the show, but am showing the first 5 seasons and the last 5 seasons separately because 10 different overlapping lines would be too much. Considering the only available range of IMDB rating values was from 7-10, this was an incredibly successful show. Never having an IMDB rating below 7 is quite impressive. That being said, each season had a similar distribution of frequency, with most episodes ranking between 8 and 8.5. In the first plot, it shows that over time the frequency of a rating of 8 decreased and the distribution started to skew more left, which shows gradual improvement over time and a higher frequency of better ratings. The last 5 seasons have differing distributions and do not show this pattern, but have a higher frequency of a wider range of views, from 8 to 9. 
...
![Views vs Ratings Emotion Boxplots](plots/views_ratings_by_emotion.png){#fig-box2}
...
::: {.callout-tip icon="false"}
## Interview with David Crane and Marta Kauffman

Byrne, Suzy. (2023, Nov. 3). *‘There Are No Stars Here’: How the ‘friends’ Cast Bonded When the Show Began - and Became ‘a Family.* Yahoo!. [www.yahoo.com/entertainment/friends-cast-bond-friendship-on-off-screen-matthew-perry-163946293.html](www.yahoo.com/entertainment/friends-cast-bond-friendship-on-off-screen-matthew-perry-163946293.html)
:::
